...
class Toolbar(Frame):#Toolbar class
	...
	def __init__(self, master):#Create toolbar/buttons
		...
		Pycrypt.createToolTip(self.power, 'Power Button')
		...
		Pycrypt.createToolTip(self.strip, 'Strip Characters')
		...
		Pycrypt.createToolTip(self.railfence, 'Railfence Shift')
		...
		Pycrypt.createToolTip(self.scytale, 'Scytale Shift')
		...
		Pycrypt.createToolTip(self.caesar, 'Caesar Shift Cipher')
		...
		Pycrypt.createToolTip(self.pigpen, 'Pigpen Cipher')
		...
		Pycrypt.createToolTip(self.scrabble, 'Scrabble Cipher')
		...
		Pycrypt.createToolTip(self.playfair, 'Playfair Square Cipher')
		...
		Pycrypt.createToolTip(self.digraph, 'Digraph Square Cipher')
		...
		Pycrypt.createToolTip(self.homophonic, 'Homophonic Cipher')
		...
		Pycrypt.createToolTip(self.vigener, 'Vigenere Square Cipher')
		...
		Pycrypt.createToolTip(self.enigma, 'Enigma Machine')
		...
		Pycrypt.createToolTip(self.freqlet, 'Frequency Analysis')
		...
		Pycrypt.createToolTip(self.freqdouble, 'Frequency Double Letters')
		...
		Pycrypt.createToolTip(self.voweltrowel, 'Vowel Trowel')
